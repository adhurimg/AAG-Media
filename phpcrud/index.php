...
?>
    ...
    <div class="container-fluid bg-3 text-center">
        ...
        <a href="login.php" class="btn btn-primary pull-right" style='margin-top:-30px'><span class=""></span> <b>+</b> Add Record</a>
        <br>

        <div class="panel panel-primary">
            <div class="panel-heading">List of appointments in the following days!</div>
