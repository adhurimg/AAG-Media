...
?>
    <div class="container-fluid bg-3 text-center">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">Edit your appointment!</div>
            <form class="form-horizontal" method="post">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input class="form-control" value= "<?=$user->mobile_no?>"type="number" name="mobile_no" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2">Service:<span style='color:red'>*</span></label>
                        <div class="col-sm-5">
                            <textarea rows="5" cols="5" class="form-control" name="address" required><?=$user->service?></textarea>
                        </div>
